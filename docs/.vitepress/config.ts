  ...
  themeConfig: {
    ...
    sidebar: {
      '/chapters/': [
        ...
        { text: '第8章 NP完全性与近似：验证的艺术', link: '/chapters/ch08-np-completeness' },
        { text: '第9章 从单机到分布式：规模改变算法', link: '/chapters/ch09-distributed-algorithms' },
        { text: '第10章 从存储到流式：内存改变算法', link: '/chapters/ch10-streaming-algorithms' },
