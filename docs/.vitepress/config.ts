  ...
  themeConfig: {
    ...
    sidebar: {
      '/chapters/': [
        ...
        {
          text: '第7章 贪心：何时信任局部选择',
          link: '/chapters/ch7/',
          collapsed: true,
          items: [
            { text: '导入', link: '/chapters/ch7/' },
            { text: '7.1 图的表示', link: '/chapters/ch7/01-graph-representation' },
            { text: '7.2 BFS与DFS', link: '/chapters/ch7/02-bfs-dfs' },
            { text: '7.3 拓扑与强连通分量', link: '/chapters/ch7/03-topology-scc' },
            { text: '7.4 最小生成树', link: '/chapters/ch7/04-mst' },
            { text: '7.5 最短路径', link: '/chapters/ch7/05-shortest-path' },
            { text: '7.6 网络流', link: '/chapters/ch7/06-network-flow' },
            { text: '7.7 建模艺术', link: '/chapters/ch7/07-modeling' },
            { text: '7.8 综合练习', link: '/chapters/ch7/08-exercises' },
          ],
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '导入', link: '/chapters/ch8/' },
            { text: '8.1 验证与发现', link: '/chapters/ch8/01-verification-discovery' },
            { text: '8.2 P vs NP', link: '/chapters/ch8/02-p-vs-np' },
            { text: '8.3 NP完全性与Cook定理', link: '/chapters/ch8/03-np-completeness-cook' },
            { text: '8.4 影射的艺术', link: '/chapters/ch8/04-reduction-art' },
            { text: '8.5 经典影射链', link: '/chapters/ch8/05-classic-reduction-chain' },
            { text: '8.6 识别NP完全问题', link: '/chapters/ch8/06-identifying-np-complete' },
            { text: '8.7 应对策略', link: '/chapters/ch8/07-coping-strategies' },
            { text: '8.8 LLM时代', link: '/chapters/ch8/08-llm-era' },
            { text: '8.9 综合练习', link: '/chapters/ch8/09-exercises' },
          ],
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '导入', link: '/chapters/ch9/' },
            { text: '9.1 成本模型', link: '/chapters/ch9/01-cost-model' },
            { text: '9.2 MapReduce', link: '/chapters/ch9/02-mapreduce' },
            { text: '9.3 共识算法', link: '/chapters/ch9/03-consensus' },
            { text: '9.4 一致性模型', link: '/chapters/ch9/04-consistency-models' },
            { text: '9.5 分区策略', link: '/chapters/ch9/05-partition' },
            { text: '9.6 容错机制', link: '/chapters/ch9/06-fault-tolerance' },
            { text: '9.7 LLM分布式推理', link: '/chapters/ch9/07-llm-distributed' },
            { text: '9.8 分布式图算法', link: '/chapters/ch9/08-distributed-graph' },
            { text: '9.9 综合练习', link: '/chapters/ch9/09-exercises' },
          ],
        },
        {
