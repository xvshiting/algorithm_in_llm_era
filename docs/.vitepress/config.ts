      ...
      '/chapters/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '7.1 图的表示', link: '/chapters/ch07/01-graph-representation' },
            { text: '7.2 BFS与DFS', link: '/chapters/ch07/02-bfs-dfs' },
            { text: '7.3 拓扑与强连通分量', link: '/chapters/ch07/03-topology-scc' },
            { text: '7.4 最小生成树', link: '/chapters/ch07/04-mst' },
            { text: '7.5 最短路径', link: '/chapters/ch07/05-shortest-path' },
            { text: '7.6 网络流', link: '/chapters/ch07/06-network-flow' },
            { text: '7.7 建模艺术', link: '/chapters/ch07/07-modeling' },
            { text: '7.8 综合练习', link: '/chapters/ch07/08-exercises' },
          ],
        },
        {
