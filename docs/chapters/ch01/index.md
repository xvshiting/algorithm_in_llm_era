...
这些判断能力，agent 帮不了你。因为它不知道你在解决什么问题，它只知道你给了它什么描述。如果问题描述错了，它给出的代码再漂亮也是错的。
...
我们会学习复杂度分析——判断一个算法是否满足你的时间和空间约束。agent 给你的代码可能是 O(n²) 的，它不知道你的数据规模，你得自己判断行不行。

最后，我们会学习建模——把现实问题翻译成算法语言。这是人的核心能力，agent 做不到。
...
- [1.6 练习](/chapters/ch01/06-exercises)